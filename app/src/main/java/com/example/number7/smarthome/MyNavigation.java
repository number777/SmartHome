...
public class MyNavigation extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dataList.add(new DrawerItem("หน้าหลัก", R.drawable.ic_action_email));
		dataList.add(new DrawerItem("ตั้งค่า", R.drawable.ic_action_good));
		dataList.add(new DrawerItem("ประวัติการควบคุม", R.drawable.ic_action_gamepad));
		dataList.add(new DrawerItem("ออกจากระบบ", R.drawable.ic_action_labels));
	...
	public void SelectItem(int possition) {
		...
		case 2:
			...
			break;
		case 3:
            Intent intent = new Intent(this,HomeControl.class);
