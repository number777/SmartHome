...
public class Register extends Activity {
    ...
    EditText inputEmail;
    EditText inputPassword,inputConpass;
    Button btnRegister;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputConpass = (EditText) findViewById(R.id.confpword);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (  ( !inputUsername.getText().toString().equals("")) && ( !inputPassword.getText().toString().equals("")) && ( !inputFirstName.getText().toString().equals("")) && ( !inputLastName.getText().toString().equals("")) && ( !inputEmail.getText().toString().equals("")) )
                {
                    ...
                    if(!inputPassword.getText().toString().equals(inputConpass.getText().toString())){
                        ad.setMessage("Please input [Password/Confirm Password] ");
                        ad.show();
                        inputPassword.requestFocus();
                        //return false;

                    }else if ( inputUsername.getText().toString().length() > 4 ){
                    NetAsync(view);
                    ...
                    else
                    {
                        //Toast.makeText(getApplicationContext(),
                                ad.setMessage("Username should be minimum 5 characters");
                                ad.show();
                ...
                else
                {
                   // Toast.makeText(getApplicationContext(),
                    ...
                    ad.setMessage("One or more fields are empty");
                    ad.show();
                    return ;
                }
            }
